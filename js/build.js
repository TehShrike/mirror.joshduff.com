...
t.createKeyStream().on("data",function(e){t.del(e)})}}},{levelup:22,"localstorage-down":46}],2:[function(t){var e=t("noddity-butler"),n=t("levelup"),r=t("noddity-linkifier"),i=t("localstorage-down"),o=t("./routing"),a=t("./mainViewModel"),s=t("level-sublevel"),u=noddityConfig,c=function(t){return new i(t)},h=s(n("noddity-content-2",{db:c})),l=u.title.replace(/[^\w]+/g,""),f=u.debug?{refreshEvery:3e4}:void 0,d=new e(u.noddityRoot,h.sublevel(l),f),p=new r(u.pathPrefix+u.pagePathPrefix),g=new a(d,p),v=o()
